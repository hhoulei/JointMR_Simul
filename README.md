...
**Article:** *JointMR: A joint likelihood-based approach for causal effect estimation using multiple GWAS summary databases in Mendelian randomization.*  
**Authors:** Sijia Wu, Lei Hou, Hongkai Li, Fuzhong Xue
...
| `ple-plugin-JointMR.R` | Simulation under directional horizontal pleiotropy using the MR-Egger intercept plug-in correction. | Numerical results for the pleiotropy-adjusted JointMR simulations (Figure 4 and Figure S10). |
...
| `application-final.R`<br>`application-run.R` | Real-data application to blood lipid traits and type 2 diabetes. | Application estimates, heterogeneity diagnostics, pleiotropy diagnostics and relaxed-NOME estimates. |
